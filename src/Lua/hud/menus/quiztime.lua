...
function quizTime:draw(v, player, camera)
	...
	SSL.drawString(v, 160, 200 - 12, FHR.quizQuestion.answers[player.heistRound.quizTimeSelection], "TNYFN%03d", V_SNAPTOBOTTOM, FU / 2, 0,    player.heistRound.quizTimeSelected and V_GREENMAP or 0)
end
